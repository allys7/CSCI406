...
\begin{center}
{\bf
Floyd-Warshall Worksheet
}
\end{center}

\begin{figure}[h]
\center
\includegraphics[width = 2in]{floyd.pdf}
\end{figure}

\begin{enumerate}
\item What is $d[1,4]^0$?
\vspace*{0.5in}
\item What is $d[1,4]^1$?
\vspace*{0.5in}

\item What is $d[1,4]^2$?
\vspace*{0.5in}
\item What is $d[1,4]^3$?
\vspace*{0.5in}
\item What is $d[1,4]^4$?
\vspace*{0.5in}
\end{enumerate}
